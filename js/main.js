...
// remove the consent bar
    cookieConsent.classList.add('active');
    localStorage.setItem("cookieBannerDisplayed", "true");
}

/**
 * If the user agreed to the consent policy by clicking 'einversanden' when he/she visited the website first time, 
we save the user decision in the local storage of the browser. 
